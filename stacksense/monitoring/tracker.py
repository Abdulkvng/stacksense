...
class MetricsTracker:
    ...
    def _persist_event_to_db(self, event: Dict[str, Any], metadata: Optional[Dict[str, Any]] = None) -> None:
        """
        ...
        try:
            ...
            db_event = EventModel(
                ...
                method=event.get("metadata", {}).get("method") if isinstance(event.get("metadata"), dict) else None,
            )
    ...
    def get_events(self, from_db: bool = False, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """
