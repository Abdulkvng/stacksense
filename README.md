...
AI infrastructure monitoring for tracking usage, cost, and performance across OpenAI, Claude, ElevenLabs, Pinecone, and more.

## Features

- 🔍 **Automatic Tracking**: Monitor AI API calls without code changes
- 💰 **Cost Tracking**: Real-time cost calculation and breakdowns
- 📊 **Performance Metrics**: Latency, error rates, and usage analytics
- 🗄️ **Database Persistence**: SQLite (default) or PostgreSQL support
- 🔌 **Multi-Provider**: OpenAI, Anthropic, ElevenLabs, Pinecone, and more
- 📈 **Analytics**: Time-series data, top models, cost breakdowns
